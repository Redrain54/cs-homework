...
namespace OrderForm {
  public partial class FormMain : Form {
    ...
    public FormMain() {
      ...
      order.AddItem(new OrderDetail(1, new Commodity("1", "iPhone", 18888.8), 10));
      order.AddItem(new OrderDetail(2, new Commodity("2", "Doll", 188.8), 61));
      orderService.AddOrder(order);
      Order order2 = new Order(2, new Customer("2", "zhang"), new List<OrderDetail>());
      order2.AddItem(new OrderDetail(1, new Commodity("2", "Pen", 99.9), 10));
    ...
    private void btnQuery_Click(object sender, EventArgs e) {
      switch (cbxField.SelectedIndex) {
        ...
        case 2:                                                  //根据客户查询
          ...
          break;
        case 3:                                                  //根据货物查询
          bdsOrders.DataSource =orderService.QueryOrdersByCommodityName(Keyword);
          break;
